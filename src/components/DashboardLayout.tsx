...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, portalType }) => {
  ...
  const menuItems = portalType === 'patient' 
    ? [
        { path: '/patient', label: 'Dashboard', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
        ...
        { path: '/patient/records', label: 'Medical Records', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    ...
    : [
        ...
        { path: '/doctor/patients', label: 'My Patients', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      {/* Header */}
      <header className="bg-white border-b border-gray-200 py-4 px-4 md:px-8 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <span className="ml-3 px-3 py-1 bg-blue-100 text-blue-700 text-sm font-medium rounded-full">
            {portalType === 'patient' ? 'Patient Portal' : 'Doctor Portal'}
          </span>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-2 hidden md:block">
              <p className="text-sm font-medium">
                {portalType === 'patient' ? 'John Doe' : 'Dr. Michael Chen'}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 border-r border-gray-200 bg-white hidden md:block">
          ...
          <div className="p-4 border-t border-gray-200 mt-6">
            <Button asChild variant="outline" className="w-full justify-start text-red-600 border-red-200 hover:bg-red-50 hover:text-red-700">
              <Link to="/">
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:hidden fixed bottom-4 right-4 z-10">
          <Button className="rounded-full w-14 h-14 flex items-center justify-center bg-blue-600 hover:bg-blue-700 shadow-lg">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
